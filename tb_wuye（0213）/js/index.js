...
// ---------------------------------------------首页---------------------------------------------
  ...
  // ---------------------------------------------关于我们---------------------------------------------
	...
	// 点击一级栏目第三个
	$('.side_l>li:nth-child(4)').children('a').click(function(event) {
		var a = $('.side_l>li:nth-child(1) .side_child>li').length;
		var c = $('.side_l>li:nth-child(2) .side_child>li').length;
		var e = $('.side_l>li:nth-child(3) .side_child>li').length;
		var num = $(this).parent().index();
		if(a==0){
			var a=0;
	...
	$('.side_l>li:nth-child(4) .side_child>li').children('a').click(function(event) {
